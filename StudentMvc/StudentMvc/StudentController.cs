...
namespace StudentMvc
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,StudentName,Birthday,Address")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("StudentId,StudentName,Birthday,Address")] StudentModel studentModel)
        {
