    ...
    public class UserModelsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserModels != null ? 
                          ...
                          Problem("Entity set 'UserDBContext.UserModels'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Address")] UserModel userModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Address")] UserModel userModel)
        {
            if (id != userModel.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UserDBContext.UserModels'  is null.");
            }
            var userModel = await _context.UserModels.FindAsync(id);
            if (userModel != null)
            {
