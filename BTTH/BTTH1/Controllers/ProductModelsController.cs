...
namespace BTTH1.Controllers
{
    public class ProductModelsController : Controller
    {
		...
		public async Task<IActionResult> ProductByCategory(int CatId)
		{
			...
			var bTTH1Context = _context.ProductModels.Include(p => p.Brand).Include(p => p.Category).Where(p=>p.CateId == CatId);
        ...
        {
            ViewData["BrandId"] = new SelectList(_context.BrandModels, "BrandId", "BrandName");
            ViewData["CateId"] = new SelectList(_context.CategoryModels, "CateId", "CateName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDescription,ProductPrice,ProductQuantity,ProductImg,CateId,BrandId")] ProductModels productModels)
        {
           // if (ModelState.IsValid)
            ...
            ViewData["BrandId"] = new SelectList(_context.BrandModels, "BrandId", "BrandName", productModels.BrandId);
            ViewData["CateId"] = new SelectList(_context.CategoryModels, "CateId", "CateName", productModels.CateId);
            // return View(productModels);
            return RedirectToAction(nameof(Index));
        }
